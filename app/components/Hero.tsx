  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-[60%] w-[700px] h-[700px] rounded-full bg-purple-brand/8 blur-[140px]" />
        <div className="absolute top-1/3 right-0 w-[350px] h-[350px] rounded-full bg-purple-neon/5 blur-[100px]" />
        <div className="absolute bottom-1/4 left-0 w-[300px] h-[300px] rounded-full bg-purple-brand/5 blur-[80px]" />
      </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-5xl mx-auto">
        ...
        <motion.h1
          ...
          className="text-4xl sm:text-5xl md:text-7xl font-semibold leading-[1.05] tracking-tight mb-5"
        >
